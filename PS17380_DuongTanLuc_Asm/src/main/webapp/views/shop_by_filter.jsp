...
<head>
    <meta charset="utf-8">
    <title>Sunshine Shop -  ${brand.brandName} ${category.categoryName} Product </title>
                ...
                <div class="row">
                    <div class="span12">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="<%=Common.url %>/all-products">Shop</a>
                            </li>
                            <li><span class="icon-chevron-right"></span></li>
                            <li>
                                <a href="#">${brand.brandName} ${category.categoryName}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <aside class="span3 left-sidebar" id="tourStep1">
                        <div class="sidebar-item sidebar-filters" id="sidebarFilters">
                            ...
                            <div class="underlined">
                                <h3><span class="light">View Shop</span> by ${brand.brandName} ${category.categoryName}</h3>
                            </div>
                                ...
                                <div id="filterOne" class="accordion-body collapse in">
                                    <div class="accordion-inner">
	                                    <c:forEach var="cate" items="${cates}">
									        <a href="#" data-target=".filter--${cate.categoryID}" class="selectable ${cate.categoryID==category.categoryID?'selected':''}"><i class="box"></i> ${cate.categoryName }</a>
									    </c:forEach>
                            ...
                            <div class="accordion-group">
                                ...
                                <div id="filterFour" class="accordion-body collapse in">
                                    <div class="accordion-inner">
                                    	<c:forEach var="brandz" items="${brands}">
									        <a href="#" data-target="brand${brandz.brandID}" data-type="brand" class="selectable detailed ${brandz.brandID==brand.brandID?'selected':''}"><i class="box"></i> ${brandz.brandName}</a>
									    </c:forEach>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="isotopeContainer" class="isotope-container">
								...
								<c:forEach var="item" items="${items}">
							        <jsp:include page="_item_2.jsp">
							        	...
							        	<jsp:param name="cateId" value="${item.category.categoryID }"/>
							        	<jsp:param name="brandId" value="${item.brand.brandID}"/>
