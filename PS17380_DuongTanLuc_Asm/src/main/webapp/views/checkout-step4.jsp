					...
					<div class="checkout-container">
						<div class="row">
							<div class="span10 offset1">
									...
									<tbody>
										...
										<c:forEach var="entry" items="${sessionScope.cart}">
											...
											<tr>
												...
												<td class="qty">${entry.value.quantity}</td>
												<td class="stronger">
													<div class="align-right">$ ${entry.value.getSubTotal()}</div>
								...
								<p class="right-align">
									<a href="<%=Common.url%>/checkout/done"
										class="btn btn-primary higher bold" ${sessionScope.cart.isEmpty()?'onclick="return false;"':'' }>CONFIRM &amp; PAY</a>
								</p>
							</div>
						</div>
					</div>
