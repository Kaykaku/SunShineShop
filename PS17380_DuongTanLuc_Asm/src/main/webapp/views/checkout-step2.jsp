                        ...
                        <div class="row">
                            <div class="span10 offset1">
                                ...
                                <p class="right-align">
                                    ...
                                    <a href="<%=Common.url%>/checkout/step-3" ${sessionScope.cart.isEmpty()?'onclick="return false;"':'' } class="btn btn-primary higher bold">CONTINUE</a>
                                </p>
                            </div>
                        </div>
                    </div>
